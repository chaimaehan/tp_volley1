...
public class ListEtudiantsActivity extends AppCompatActivity implements EtudiantAdapter.OnItemClickListener {
    ...
    // Update these URLs
    private String fetchUrl = "http://192.168.100.47/projete/ws/loadEtudiant.php";
    private String updateUrl = "http://192.168.100.47/projete/ws/updateEtudiant.php";
    private String deleteUrl = "http://192.168.100.47/projete/ws/deleteEtudiant.php";
    ...
    private void showEditDialog(final Etudiant etudiant) {
        ...
        builder.setTitle("Modify Student")
